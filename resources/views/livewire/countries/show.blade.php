<div wire:init="readyToLoad">
    <div wire:ignore.self class="card" id="show">
        <div class="card-header">
            <div class="row">
                <div class="col-md-4">
                    <h5 class="card-title mb-3">{{__('Countries')}}</h5>
                </div>
                <div class="col-md-8">
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        ...
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                <button class="btn btn-secondary add-new btn-primary mx-1" tabindex="0" data-bs-toggle="modal"
                                    ...
                                    <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">{{__('Add country')}}</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-inline-block text-nowrap">
                                        <button class="btn btn-icon btn-label-primary" data-bs-toggle="modal"
                                                data-bs-target="#edit" wire:click="edit({{$country}})">
                                            <i class="ti ti-edit"></i>
                                        </button>
                                        <button class="btn btn-icon btn-label-primary" data-bs-toggle="modal"
                                                data-bs-target="#delete" wire:click="delete({{$country}})">
                        ...
                        @empty
                            <tr class="odd">
                                <td valign="top" colspan="12" class="dataTables_empty text-center">{{$readyToLoad?__('No countries registered'):__('Loading').'...'}}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                        ...
                        <div class="row mx-2 my-3">
                            <div class="col-md-5">
                                <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">
                                    {{__('Showing')}} {{ $countries->firstItem() }} {{__('to')}} {{ $countries->lastItem() }} {{__('of')}} {{ $countries->total() }} {{__('results')}}
                                </div>
                            </div>
