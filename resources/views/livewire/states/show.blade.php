                        ...
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                <button class="btn btn-secondary add-new btn-primary mx-1" tabindex="0" data-bs-toggle="modal"
                                    ...
                                    <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">{{__('Add state')}}</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <tbody>
                        @forelse($states as $state)
                            <tr>
                                ...
                                <td class="text-center">{{$state->zip_code}}</td>
                                <td class="text-center">
                                    <div class="d-inline-block text-nowrap">
                                        <button class="btn btn-icon btn-label-primary" data-bs-toggle="modal"
                                                data-bs-target="#edit" wire:click="edit({{$state}})">
                                            <i class="ti ti-edit"></i>
                                        </button>
                                        <button class="btn btn-icon btn-label-primary" data-bs-toggle="modal"
                                                data-bs-target="#delete" wire:click="delete({{$state}})">
